  ...
  const items = [
    {
      ...
      a: "Nos campagnes exposent votre chaîne YouTube à une audience qualifiée correspondant à votre niche, via des techniques de promotion ciblée. Les abonnés gagnés sont de vraies personnes, intéressées par votre contenu. Aucun bot, aucune ferme à clics, aucune automation interdite.",
    },
    {
      q: "Est-ce que je dois vous donner mon mot de passe ?",
      a: "Jamais. On a uniquement besoin de votre handle YouTube public (@votrechaine). Aucun accès au compte, aucun risque.",
    },
    {
      q: "Ma chaîne risque-t-elle d'être suspendue ?",
      a: "Non. Notre méthode est 100% conforme aux conditions d'utilisation de YouTube. Aucune automation interdite, aucune action sur votre compte. La croissance reste progressive et naturelle.",
    },
    {
      q: "En combien de temps les premiers résultats arrivent ?",
      a: "La campagne démarre sous quelques minutes après le paiement. Les premiers abonnés arrivent généralement sous 24 à 48h, puis la campagne s'étale sur 14 à 60 jours selon le pack, pour une croissance 100% naturelle.",
    },
    {
