...
export default function Reviews() {
  const reviews = [
    { n: "Julien D.", d: "il y a 2 jours", t: "Ma chaîne a vraiment décollé, abonnés FR engagés sur mes vidéos.", r: 5 },
    { n: "Marie L.", d: "il y a 7 jours", t: "Campagne lancée en quelques minutes, premiers abonnés sous 48h.", r: 5 },
    { n: "Pierre F.", d: "il y a 5 jours", t: "Top, j'ai vu mes abonnés monter progressivement sur 3 semaines.", r: 5 },
    { n: "Lucie B.", d: "il y a 10 jours", t: "Première campagne YouTube, c'est sérieux et le suivi est top.", r: 5 },
    { n: "Karim T.", d: "il y a 5 jours", t: "Excellent service, mes vidéos remontent dans les recommandations.", r: 5 },
