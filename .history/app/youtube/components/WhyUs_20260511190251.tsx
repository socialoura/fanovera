  ...
  const items = [
    {
      ...
      body: "Notre IA identifie de vraies personnes correspondant à votre niche et leur expose votre chaîne YouTube.",
    },
    {
      i: "🛡",
    ...
    },
    {
      ...
      body: "Juste votre handle public. Aucun accès au compte, aucun risque pour votre chaîne.",
    },
    {
      i: "↩",
