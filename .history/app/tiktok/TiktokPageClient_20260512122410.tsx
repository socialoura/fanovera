...
export default function TiktokPageClient() {
  ...
  const { currency, locale, resolvePrice } = useCurrencyPricing("followers");
  ...
  return (
    <>
      <div className="paper-frame with-tt-halo">
        ...
        {step === 3 && <Step3Checkout country={country} pack={pack} username={username} email={email} profile={profile} clientSecret={clientSecret} onBack={back} onBackToPacks={backToPacks} />}
      </div>
