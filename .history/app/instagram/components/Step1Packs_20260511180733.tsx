    ...
    <section className="slide-in" style={{ padding: "40px 0 0", position: "relative" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto 24px" }}>
          ...
          <p style={{ marginTop: 12, fontSize: 15, color: "var(--ink-2)", lineHeight: 1.55, maxWidth: 580, marginLeft: "auto", marginRight: "auto" }}>
            Nos campagnes exposent votre profil à une audience qualifiée sur Instagram. Vous gagnez des abonnés réellement intéressés par votre contenu, sans bot, sans automation interdite.
          </p>
        </div>
