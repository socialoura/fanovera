...
export default function Step1Packs({ country, pack, setPack, onNext }: Props) {
  ...
  const handlePackClick = (index: number) => {
    ...
    requestAnimationFrame(() => {
      orderCardRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
    });
  };
    ...
    <section className="slide-in" style={{ padding: "40px 0 0", position: "relative" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          <div ref={orderCardRef} style={{ background: "white", border: "2px solid var(--tw-purple)", borderRadius: 22, padding: 24, position: "relative", boxShadow: "0 18px 40px -16px rgba(145,70,255,0.35)" }}>
