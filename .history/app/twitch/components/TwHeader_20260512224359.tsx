...
export default function TwHeader() {
  ...
  return (
    <div className="tw-header" data-i18n-skip style={{ padding: "24px 0" }}>
      <div className="container pf-header">
        ...
        <nav className="nav-pill">
          ...
          <Link href="/#networks">{t.header.allNetworks}</Link>
          <Link href="/track">{t.header.tracking}</Link>
        </nav>
