...
export default function Reviews() {
  const t = useInstagramCopy().reviews;
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            <div style={{ fontSize: 48, fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1, color: "var(--ig-2)" }}>4,91</div>
            ...
            {[
              ...
              <div key={b.r} style={{ display: "flex", gap: 8, alignItems: "center", fontSize: 12 }}>
                ...
                <div style={{ flex: 1, height: 6, background: "var(--paper-2)", borderRadius: 3, overflow: "hidden" }}>
                  <div style={{ height: "100%", width: (b.n / 2048) * 100 + "%", background: "var(--yellow)", borderRadius: 3 }} />
                </div>
          ...
          {reviews.map((review, i) => (
            <div key={i} className="review-card">
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <div style={{ fontSize: 13, fontWeight: 700 }}>{review.n}</div>
              ...
              <div style={{ fontSize: 11, color: "var(--ink-3)", marginBottom: 10 }}>{review.d}</div>
              <p style={{ margin: 0, fontSize: 13, color: "var(--ink)", lineHeight: 1.5 }}>{review.text}</p>
            </div>
          ))}
        </div>
      </div>
