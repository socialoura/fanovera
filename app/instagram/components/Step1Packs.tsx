...
export default function Step1Packs({ country, pack, setPack, onNext, productType, setProductType }: Props) {
  ...
  // Preserves the visitor's quantity intent across the product-type toggle:
            ...
            {packs.map((p, i) => (
              ...
              >
                ...
                <div style={{ marginTop: 8 }}>
                  <span style={{ display: "inline-block", fontSize: 13, color: "var(--green)", fontWeight: 700, padding: "3px 8px", background: "rgba(77,191,138,0.12)", borderRadius: 6 }}>
