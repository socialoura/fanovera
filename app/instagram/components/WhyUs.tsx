      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 48px" }}>
          ...
          <h2 className="display" style={{ fontSize: "clamp(32px, 4.2vw, 56px)", margin: 0 }}>
            {t.title1}
            <br />
            <span className="squiggle ig">{t.title2}</span> {t.title3}
          </h2>
        </div>
            ...
            <div key={i} className="why-card" style={{ padding: 20 }}>
              <div
                style={{
                  ...
                  height: 42,
                  borderRadius: 12,
                  background: "linear-gradient(135deg, rgba(250,126,30,0.15), rgba(214,41,118,0.15))",
                  display: "grid",
                  placeItems: "center",
                  fontSize: 18,
                  marginBottom: 12,
