...
export default function Step3Checkout({ country, pack, username, onBack }: Props) {
  ...
  const methods: { id: PayMethod; label: string; icon: ReactNode }[] = [
    ...
    { id: "google", label: "G Pay", icon: <span style={{ fontWeight: 800, fontSize: 14 }}>G</span> },
    {
      ...
      label: "PayPal",
      icon: (
        <span style={{ fontWeight: 800, fontSize: 12, color: "#003087" }}>
            ...
            >
              {methods.map((m) => (
                <button
                  ...
                  style={{
                    padding: "14px 8px",
                    background: paymethod === m.id ? "white" : "var(--paper-2)",
                    border:
                      "2px solid " + (paymethod === m.id ? "var(--ig-2)" : "transparent"),
                    borderRadius: 12,
                    display: "flex",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  <div>
                    ...
                    <div className="input-shell">
                      <input type="text" placeholder="MM/AA" defaultValue="12/28" />
                    </div>
                  </div>
                  <div>
                    <label
          ...
          <div>
            ...
            >
              ...
              <button
                ...
                style={{ width: "100%", padding: "16px 26px", fontSize: 16 }}
              >
