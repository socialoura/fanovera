...
export default function IgHeader() {
  const t = useInstagramCopy().header;
      ...
      <div className="container pf-header">
        ...
        <div className="pf-header-actions" style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <a
            href="#cart"
            className="hide-md"
            style={{ width: 40, height: 40, borderRadius: 12, background: "white", border: "1px solid var(--line)", display: "grid", placeItems: "center", position: "relative" }}
            aria-label="Cart"
          >
