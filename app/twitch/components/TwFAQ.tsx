    ...
    <section id="faq" data-i18n-skip style={{ padding: "80px 0", background: "var(--frame)", position: "relative", overflow: "hidden" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 48px" }}>
          ...
          <h2 className="display" style={{ fontSize: "clamp(32px, 4.2vw, 56px)", margin: 0 }}>{t.faq.titleBefore} <span className="squiggle tw">{t.faq.titleFocus}</span>.</h2>
        </div>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          {t.faq.items.map(([q, a], i) => (
            <div key={q} className={"faq-item tw" + (open === i ? " open" : "")}>
