...
type Props = {
  ...
  setProductType: (t: TwitchProductType) => void;
};
...
export default function Step1Packs({ country, pack, setPack, onNext, productType, setProductType }: Props) {
  ...
  const audienceLabel = productType === "ai_viewers" ? t.step1.audienceAiViewers : t.step1.audience;
          ...
          <div ref={orderCardRef} style={{ background: "white", border: "2px solid var(--tw-purple)", borderRadius: 22, padding: 24, position: "relative", boxShadow: "0 18px 40px -16px rgba(145,70,255,0.3)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", padding: "14px 0" }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <div style={{ fontSize: 12, color: "var(--green)", fontWeight: 700, marginTop: 4 }}>{t.step1.discount} {fmtEuro(savings)}</div>
              </div>
            </div>
