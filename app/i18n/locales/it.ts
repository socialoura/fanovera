...
const it: LocaleDictionary = {
  ...
  status: {
    operational: "Tutti i servizi sono operativi",
    asOf: "al",
  },
  seo: {
  ...
  exact: { ...en.exact, Suivi: "Monitoraggio", Commencer: "Inizia", Produit: "Prodotto", "Fonctionnement": "Come funziona", "Témoignages": "Recensioni", "Société": "Azienda", Confidentialité: "Privacy", Continuer: "Continua", Retour: "Indietro", Payer: "Paga", "Commande confirmée": "Ordine confermato", "Commande confirmÃ©e": "Ordine confermato", "Suivi de commande": "Monitoraggio ordine", "Retour à l'accueil": "Torna alla home", "Retour Ã  l'accueil": "Torna alla home", "Voir la solution": "Vedi la soluzione" },
  fragments: [
    ...
    ["Une visibilitÃ©", "Visibilità su"],
    ["Pack visibilité", "Pacchetto visibilità"],
    ["Pack visibilitÃ©", "Pacchetto visibilità"],
    ["crédit inclus", "credito incluso"],
    ["crÃ©dit inclus", "credito incluso"],
    ...
    ["aucun accÃ¨s demandÃ©", "nessun accesso richiesto"],
    ["Le compte doit être public", "L'account deve essere pubblico"],
    ["Le compte doit Ãªtre public", "L'account deve essere pubblico"],
    ["Chargement du paiement sécurisé", "Caricamento pagamento sicuro"],
    ["Chargement du paiement sÃ©curisÃ©", "Caricamento pagamento sicuro"],
    ["Merci pour votre achat. Votre commande a bien été prise en compte.", "Grazie per l'acquisto. Il tuo ordine è stato ricevuto."],
    ["Merci pour votre achat. Votre commande a bien Ã©tÃ© prise en compte.", "Grazie per l'acquisto. Il tuo ordine è stato ricevuto."],
  ],
};
