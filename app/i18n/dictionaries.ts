...
const broadReplacements: Record<Exclude<SupportedLocale, "fr">, Array<[string, string]>> = {
  ...
  es: [
    ...
    ["Légal", "Legal"], ["Mentions légales", "Aviso legal"],
    ["Suivi de commande", "Seguimiento del pedido"], ["Paiement sécurisé", "Pago seguro"],
    ["Récapitulatif", "Resumen"], ["Appliquer", "Aplicar"], ["Appliqué", "Aplicado"],
    ["économie", "ahorro"], ["Aucun abonnement caché", "Sin suscripción oculta"],
    ["Retour au choix des packs", "Volver a elegir pack"], ["Compte préservé", "Cuenta protegida"], ["Compte preserve", "Cuenta protegida"],
    ["Audience ciblée", "Audiencia enfocada"], ["Sans mot de passe", "Sin contraseña"],
    ["Votre page", "Tu página"], ["Votre vidéo", "Tu video"], ["Votre morceau", "Tu canción"], ["Votre chaîne", "Tu canal"],
    ["promouvoir", "promocionar"], ["Lien invalide", "Enlace inválido"], ["Compte introuvable", "Cuenta no encontrada"], ["Vidéo introuvable", "Video no encontrado"], ["Morceau introuvable", "Canción no encontrada"],
    ...
    ["Envoyer le message", "Enviar mensaje"], ["Envoi", "Enviando"], ["Message envoyé", "Mensaje enviado"], ["Fermer", "Cerrar"],
    ["Tous nos services sont opérationnels", "Todos los servicios están operativos"],
    ["Ils nous font confiance", "Confían en nosotros"], ["Vos questions", "Tus preguntas"], ["nos réponses", "nuestras respuestas"],
  ...
  de: [
    ["Tous les réseaux", "Alle Netzwerke"], ["Comment ça marche", "So funktioniert es"],
    ["Résultats garantis", "Begleitplan"], ["Légal", "Rechtliches"], ["Mentions légales", "Impressum"],
    ["Suivi de commande", "Bestellstatus"], ["Paiement sécurisé", "Sichere Zahlung"], ["Récapitulatif", "Zusammenfassung"],
    ["Appliquer", "Anwenden"], ["Appliqué", "Angewendet"], ["économie", "Ersparnis"], ["Aucun abonnement caché", "Kein verstecktes Abo"],
    ["Retour au choix des packs", "Zur Paketauswahl"], ["Compte préservé", "Konto geschützt"], ["Compte preserve", "Konto geschützt"], ["Audience ciblée", "Zielgruppe"],
    ["Sans mot de passe", "Ohne Passwort"], ["Votre page", "Deine Seite"], ["Votre vidéo", "Dein Video"], ["Votre morceau", "Dein Track"], ["Votre chaîne", "Dein Kanal"],
    ["promouvoir", "bewerben"], ["Lien invalide", "Ungültiger Link"], ["Compte introuvable", "Konto nicht gefunden"], ["Vidéo introuvable", "Video nicht gefunden"], ["Morceau introuvable", "Track nicht gefunden"],
    ...
    ["Envoyer le message", "Nachricht senden"], ["Envoi", "Senden"], ["Message envoyé", "Nachricht gesendet"], ["Fermer", "Schließen"],
    ["Tous nos services sont opérationnels", "Alle Dienste sind betriebsbereit"], ["Ils nous font confiance", "Sie vertrauen uns"], ["Vos questions", "Deine Fragen"], ["nos réponses", "unsere Antworten"]],
  it: [
