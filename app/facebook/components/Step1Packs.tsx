      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="pack-grid" style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 14, marginBottom: 32 }}>
            {PACKS.map((p, i) => (
              <button key={i} onClick={() => setPack(i)} className={`pack-tile fb ${pack === i ? "selected" : ""} ${p.popular ? "popular" : ""} ${p.best ? "best" : ""}`}>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          <div style={{ background: "white", border: "2px solid var(--fb-blue)", borderRadius: 22, padding: 24, position: "relative", boxShadow: "0 18px 40px -16px rgba(24,119,242,0.3)" }}>
