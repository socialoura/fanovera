    ...
    <div className="li-header" style={{ padding: "24px 0" }}>
      <div className="container pf-header">
        ...
        <nav className="nav-pill">
          ...
          <a href="/linkedin" className="active">LinkedIn</a>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <a href="/" className="hide-md" style={{ width: 40, height: 40, borderRadius: 12, background: "white", border: "1px solid var(--line)", display: "grid", placeItems: "center", position: "relative" }} aria-label="Accueil">
