...
export default function LiHeader() {
  return (
    <div className="li-header" style={{ padding: "24px 0" }}>
      <div className="container pf-header">
        ...
        <nav className="nav-pill">
          ...
          <Link href="/linkedin" className="active">LinkedIn</Link>
          <Link href="/#networks">Tous les rÃ©seaux</Link>
        ...
        <div className="pf-header-actions" style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div className="hide-md" style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 13, color: "var(--ink-2)" }}>
            ...
            <span>Â· 2 348 avis</span>
          </div>
          <Link href="/" className="hide-md" style={{ width: 40, height: 40, borderRadius: 12, background: "white", border: "1px solid var(--line)", display: "grid", placeItems: "center", position: "relative" }} aria-label="Accueil">
