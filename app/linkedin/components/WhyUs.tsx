...
export default function WhyUs() {
  const items = [
    { i: "ðŸŽ¯", title: "Audience B2B ciblÃ©e", body: "Notre IA expose votre profil Ã  des dÃ©cideurs et professionnels qualifiÃ©s dans votre secteur." },
    ...
    { i: "ðŸ”’", title: "Sans mot de passe", body: "Juste le lien public de votre profil. Aucun acces au compte n'est demande." },
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto 48px" }}>
          ...
          <h2 className="display" style={{ fontSize: "clamp(32px, 4.2vw, 56px)", margin: 0 }}>
            Une croissance LinkedIn<br /><span className="squiggle li">progressive</span> et soignee.
          </h2>
        </div>
