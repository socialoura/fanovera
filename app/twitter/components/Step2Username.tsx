        ...
        <div className="checkout-grid" style={{ display: "grid", gridTemplateColumns: "1fr 0.9fr", gap: 36, maxWidth: 1320, margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ marginTop: 24 }}>
              <label htmlFor="x-checkout-email" style={{ display: "block", fontSize: 13, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--ink-3)", marginBottom: 10 }}>
                {t.emailLabel}
              </label>
              <div className="input-shell x">
                <input
            ...
            <div style={{ marginTop: 28, display: "flex", gap: 10 }}>
              ...
              <button type="submit" className="btn-primary btn-x" style={{ flex: 1, padding: "14px 26px", fontSize: 16 }}>
                {t.pay}
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
