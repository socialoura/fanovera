      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto 24px" }}>
          ...
          <div className="yt-mode-toggle" style={{ marginTop: 20, marginBottom: 0 }}>
            ...
            <button className={productType === "subscribers" ? "active" : ""} onClick={() => switchProduct("subscribers")}>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          <div ref={orderCardRef} style={{ background: "white", border: "2px solid var(--yt-red)", borderRadius: 22, padding: 24, position: "relative", boxShadow: "0 18px 40px -16px rgba(255,0,0,0.3)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--yt-red)" }}>{t.campaign}</div>
            </div>
