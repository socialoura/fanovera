...
import { PACKS, LIKES_PACKS, VIEWS_PACKS, type CountryId, type TikTokProductType, formatPrice, formatQty, getPacksForProduct, getServiceForProduct, defaultPackIndex } from "../tiktok/data";
...
export default function TiktokOldPageClient() {
