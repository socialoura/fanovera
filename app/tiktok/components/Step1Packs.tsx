      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto 24px" }}>
          ...
          <h1 className="display" style={{ margin: 0, fontSize: "clamp(26px, 4.4vw, 48px)" }}>
            Une visibilite TikTok <span className="squiggle">ciblee</span> & progressive.
          </h1>
        </div>
            ...
            {PACKS.map((p, i) => (
              <button key={i} onClick={() => handlePackClick(i)} className={"pack-tile" + (pack === i ? " selected" : "") + (p.popular ? " popular" : "") + (p.best ? " best" : "")}>
                ...
                <div style={{ marginTop: 14, paddingTop: 14, borderTop: "1px dashed var(--line)" }}>
                  <div style={{ fontSize: 18, fontWeight: 800, color: pack === i ? "var(--tt-red)" : "var(--ink)", letterSpacing: "-0.01em" }}>{formatPrice(p, country)}</div>
        ...
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          <div ref={orderCardRef} style={{ background: "white", border: "2px solid var(--tt-red)", borderRadius: 22, padding: 24, position: "relative", boxShadow: "0 18px 40px -16px rgba(254,44,85,0.3)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--tt-red)" }}>Votre campagne</div>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 0", borderBottom: "1px dashed var(--line)" }}>
              <div>
                ...
                <div style={{ fontWeight: 700, fontSize: 16, marginTop: 2 }}>
                  Pack visibilite TikTok {formatQty(selectedPack.qty)}
