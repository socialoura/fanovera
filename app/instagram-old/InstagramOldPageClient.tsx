...
import { PACKS, LIKES_PACKS, VIEWS_PACKS, REPOST_PACKS, type CountryId, type InstagramProductType, formatPrice, formatQty, getPacksForProduct, getServiceForProduct, defaultPackIndex } from "../instagram/data";
...
export default function InstagramOldPageClient({ checkoutFlowVariant = "control" }: { checkoutFlowVariant?: CheckoutFlowVariant } = {}) {
